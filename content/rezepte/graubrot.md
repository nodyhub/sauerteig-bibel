---
title: Feines Graubrot
weight: 20
---

# Das feine Graubrot (Der Allrounder)
...
Da wir kein Weizen verwenden, braucht das Dinkel-Roggen-Gemisch die Essig-Säure zur Stabilisierung. Sie übernimmt die Rolle, die sonst das Gluten alleine trägt.

## Ablauf

Folge dem [Master-Prozess](../../master-prozess/). Dieses Rezept benötigt:
- **Phase 1 (Autolyse):** 25-30 Minuten
- **Phase 2 (Hauptteig & Kneten):** Dinkel ist empfindlich! Nur Stufe 1 (langsam), maximal 4-5 Min. **SOFORT STOPP** sobald homogen.
...
- Dunklere, feine Krume ideal für Wurst & Käse
- Nicht zu kernig, aber charaktervoll
- Sehr kinderfreundlich
- Stabil und saftig über längere Zeit
